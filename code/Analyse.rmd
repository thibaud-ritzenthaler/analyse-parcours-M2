...
inert_traj <- plot(sort(seq.agnes$height, decreasing=TRUE) [1:10], type="s", xlab="nb de classes", ylab="inertie")
dendo_traj <- plot(as.dendrogram(seq.agnes), leaflab="none")
